  ...
  if (gif) {
    return (
      <>
        <center>
          <img
            src={require("../../img/load1.gif")}
            alt="load"
            style={{ height: "20%", width: "20%", marginTop: "50px" }}
          />
          ...
          <div className="card">
            <div className="card-Header">
              <div className="card-pic">
                <img
                  src={
                    post.postedBy.Photo ? post.postedBy.Photo : ProfilePicLink
                  }
                  alt=""
                />
              </div>
          ...
          <div className="comment-container">
            ...
            <div className="comment-details">
              ...
              <div className="card-comment">
                ...
                <button
                  onClick={() => {
                    PostComment(comment, commentPic._id);
                    viewComments();
                  }}
                  className="comment-btn"
                >
